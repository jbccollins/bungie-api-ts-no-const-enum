...
export function getAvailableAvatars(
  http: HttpClient
): Promise<ServerResponse<{ [key: number]: string }>> {
 ...
 */
export function getUserClanInviteSetting(
  http: HttpClient,
 ...
 * version.
 */
export function getGroupByNameV2(
  http: HttpClient,
...
export function getGroupOptionalConversations(
  http: HttpClient,
 ...
 */
export function editClanBanner(
  http: HttpClient,
 ...
 */
export function editFounderOptions(
  http: HttpClient,
 ...
 * group.
 */
export function addOptionalConversation(
  http: HttpClient,
 ...
 */
export function editOptionalConversation(
  http: HttpClient,
...
export function getAdminsAndFounderOfGroup(
  http: HttpClient,
 ...
 */
export function editGroupMembership(
  http: HttpClient,
 ...
 */
export function getBannedMembersOfGroup(
  http: HttpClient,
 ...
 */
export function abdicateFoundership(
  http: HttpClient,
...
export function getInvitedIndividuals(
  http: HttpClient,
...
/** Approve all of the pending users for the given group. */
export function approvePendingForList(
  http: HttpClient,
...
export function denyPendingForList(
  http: HttpClient,
...
export function getGroupsForMember(
  http: HttpClient,
 ...
 * bungie.net
 */
export function recoverGroupForFounder(
  http: HttpClient,
...
export function individualGroupInvite(
  http: HttpClient,
...
export function individualGroupInviteCancel(
  http: HttpClient,
