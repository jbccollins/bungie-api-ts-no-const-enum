...
export function getCoreTopicsPaged(
  http: HttpClient,
...
export function getPostAndParent(
  http: HttpClient,
 ...
 * approval.
 */
export function getPostAndParentAwaitingApproval(
  http: HttpClient,
...
export function getTopicForContent(
  http: HttpClient,
 ...
 */
export function getForumTagSuggestions(
  http: HttpClient,
 ...
 * objects.
 */
export function getRecruitmentThreadSummaries(
  http: HttpClient,
  body: string[]
