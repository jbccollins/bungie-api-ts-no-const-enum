...
export function claimPartnerOffer(
  http: HttpClient,
 ...
 */
export function getPartnerOfferSkuHistory(
  http: HttpClient,
 ...
 * and Twitch drops.
 */
export function getPartnerRewardHistory(
  http: HttpClient,
...
export function getBungieRewardsForUser(
  http: HttpClient,
  params: GetBungieRewardsForUserParams
): Promise<ServerResponse<{ [key: string]: BungieRewardDisplay }>> {
 ...
 * and Type are used.
 */
export function getBungieRewardsForPlatformUser(
  http: HttpClient,
