...
export function getBungieNetUserById(
  http: HttpClient,
 ...
 * cached.
 */
export function getSanitizedPlatformDisplayNames(
  http: HttpClient,
  params: GetSanitizedPlatformDisplayNamesParams
): Promise<ServerResponse<{ [key in BungieCredentialType]: string }>> {
...
export function getCredentialTypesForTargetAccount(
  http: HttpClient,
 ...
 */
export function getMembershipDataById(
  http: HttpClient,
 ...
 */
export function getMembershipFromHardLinkedCredential(
  http: HttpClient,
...
export function searchByGlobalNamePrefix(
  http: HttpClient,
...
export function searchByGlobalNamePost(
  http: HttpClient,
